                ...
                return (
                  ...
                  >
                    <div className="container">
                      ...
                      <p className="mb-0">{singleConfference.description}</p>
                      <h2 className="mt-3 mb-0 rounded">
                        <span className="conferenceDateDiv rounded">
                          {this.findMonth(singleConfference.fromTime)}{" "}
                          {this.findDate(singleConfference.fromTime)} -{" "}
                          {this.findMonth(singleConfference.toTime)}{" "}
                          {this.findDate(singleConfference.toTime)},{" "}
                          {this.findYear(singleConfference.fromTime)}
                        </span>
                      </h2>
