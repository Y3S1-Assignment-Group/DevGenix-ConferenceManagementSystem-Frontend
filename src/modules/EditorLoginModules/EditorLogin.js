...
class EditorLogin extends Component {
  ...
  onLogin(e) {
    ...
    const loginEditorObj = {
      email: this.state.email,
      password: this.state.password,
    };

    this.props.editorLogin(
      loginEditorObj,
      () => {
        this.setState({
          ...
          <Card>
            <CardBody className="p-5">
              <div className="row">
                ...
                <div className="col-lg-6 col-md-6 container">
                  <h3 className="mb-2 mt-5 font-weight-bold">EDITOR LOGIN</h3>
                  <hr />
...
const mapActionToProps = {
  editorLogin: actions.editorLogin,
};

export default connect(null, mapActionToProps)(EditorLogin);
