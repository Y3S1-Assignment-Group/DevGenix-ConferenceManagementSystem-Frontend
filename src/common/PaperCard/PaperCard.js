        ...
        >
          <CardBody>
            {this.props.researcher ? (
              <div>
                <p className="text-white text-uppercase font-weight-bold text-warning">
            ...
            <Button className="bg-transparent border-0">
              <a
                href={this.props.reasearchPaper.researchPaper.approved}
                target="_blank"
              >
            ...
            <ModalBody>
              <div>
                ...
                <h6>
                  ...
                  <span>
                    {" "}
                    {this.props.reasearchPaper.universityOrWorkPlace}
                  </span>
                </h6>
              </div>
            </ModalBody>
